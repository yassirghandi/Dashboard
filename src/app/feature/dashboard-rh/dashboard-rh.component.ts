...
export class DashboardRHComponent implements OnInit{
  ...
  dashboardRhdata ! : DashboardRhData;
  chart:any;

  constructor(private  dashboardRHService : DashboardRHService){}

  ngOnInit(): void {
    this.loadDashboardRHData();
  }

  loadDashboardRHData():void {
    this.dashboardRHService.getDashboardData().subscribe(
      (data : DashboardRhData)=>{
        this.dashboardRhdata = data ;
  ...
  cards = [
    { title: 'Nombre de commandes client', value: 175 },
    { title: 'Nombre de produits à réapprovisionner', value: 18 },
    { title: 'Nombre d\'alertes', value: 0 },
    { title: 'Nombre de transferts', value: 50 },
    { title: 'Stocks négatifs', value: 9 },
    { title: 'Produits en rupture de stock', value: 24 }
  ];
